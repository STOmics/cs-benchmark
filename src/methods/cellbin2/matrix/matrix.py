...
def main():
    ...
    _output_path = "/storeData/USER/data/01.CellBin/00.user/fanjinghong/data/10xHD/Small_Intestine"
    sn = 'A04547A1C3'
    ...
    src_path: str = "/storeData/USER/data/01.CellBin/00.user/fanjinghong/data/10xHD/Small_Intestine/A04547A1C3.gem.gz"
